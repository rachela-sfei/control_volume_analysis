...
runid_list = ['G141_22_078','G141_22_087','G141_22_079','G141_22_081','G141_22_082']
wy_list=[2022,2022,2022,2022,2022]
server_list = ['fortcollins','fortcollins','fortcollins','fortcollins','fortcollins']
run_label_list = ['G141_22_078 (Base Case)',
                  'G141_22_087 (BACWA load reduction)',
                  'G141_22_079 (40%s load reduction)' % '%',
                  'G141_22_081 (60%s load reduction)' % '%',
                  'G141_22_082 (82%s load reduction)' % '%']
